...
test('correct todolist should change its name', () => {
    ...
    const action = todolistActions.changeTodolistTitle({title: newTodolistTitle, id: todolistId2})
...
test('correct filter of todolist should be changed', () => {
    ...
    const action = todolistActions.changeTodolistFilter({filter: newFilter, id: todolistId2})
